" -----------------------------------------------------------------------------
" Description: Groovebox scheme with a flavour of Jetbrains Dracula
" Initial Source: https://github.com/morhetz/gruvbox
" -----------------------------------------------------------------------------
...
let g:colors_name='gruvbox-modified'
...
let s:gb.gray_244    = ['#5C6370', 244]
let s:gb.gray_245    = ['#5C6370', 245]
...
" FIXME: provide correct values as the second element
let s:gb.ilya_blue        = ['#5e94aa',1]
let s:gb.ilya_pink        = ['#94558D',1]
let s:gb.ilya_orange      = ['#CC7832',1]
let s:gb.ilya_yellow      = ['#BBB529',1]
let s:gb.ilya_purple      = ['#8888C6',1]
let s:gb.ilya_peach       = ['#E5C07B',1]
let s:gb.ilya_salmon      = ['#E06C75',1]
let s:gb.ilya_bright_red  = ['#ff6b6b',1]
let s:gb.ilya_bright_blue = ['#61AFEF',1]
let s:gb.ilya_bright_pink = ['#B200B2',1]
...
" TODO: potentially, this can go away, but :shrug:
...
call s:HL('IlyaBlue', s:gb.ilya_blue)
call s:HL('IlyaPink', s:gb.ilya_pink)
call s:HL('IlyaOrange', s:gb.ilya_orange)
call s:HL('IlyaYellow', s:gb.ilya_yellow)
call s:HL('IlyaPurple', s:gb.ilya_purple)
call s:HL('IlyaPeach', s:gb.ilya_peach)
call s:HL('IlyaSalmon', s:gb.ilya_salmon)
call s:HL('IlyaBrightRed', s:gb.ilya_bright_red)
call s:HL('IlyaBrightBlue', s:gb.ilya_bright_blue)
call s:HL('IlyaBrightPink', s:gb.ilya_bright_pink)

call s:HL('IlyaRedSign', s:gb.ilya_salmon, s:sign_column, s:invert_signs)
" To test higlighting groups, when it is unclear about their use case
call s:HL('IlyaTest', s:fg1, s:red)
...
call s:HL('Visual',    s:none,  ['#6A758B', 1], s:invert_selection)
hi! link VisualNOS Visual

call s:HL('Search',    s:yellow, s:bg0, s:inverse)
" call s:HL('Search',    ['#98C379', 1], s:bg0, s:inverse)
...
hi! link WarningMsg GruvboxYellow
...
call s:HL('Todo', ['#A35F96', 1], s:bg0, s:bold . s:italic)
call s:HL('Error', s:red, s:bg0, s:bold . s:inverse)

" Generic statement
hi! link Statement IlyaOrange
" if, then, else, endif, swicth, etc.
hi! link Conditional IlyaOrange
" for, do, while, etc.
hi! link Repeat IlyaOrange
" case, default, etc.
hi! link Label IlyaOrange
" try, catch, throw
hi! link Exception IlyaOrange
" sizeof, "+", "*", etc.
hi! link Operator Normal
" Any other keyword
hi! link Keyword IlyaOrange

" Variable name
hi! link Identifier GruvboxBlue
" Function name
hi! link Function IlyaBrightBlue

" TODO: need to figure out what these are for. But looks like we can use IlyaOrange
...
hi! link Number IlyaPeach
" Floating point constant: 2.3e10
" hi! link Float GruvboxPurple
hi! link Float IlyaPeach

" Generic type
hi! link Type IlyaPeach
...
if version >= 700
  ...
  call s:HL('Pmenu', s:fg2, ['#46484a',1])
  " Popup menu: scrollbar
  " call s:HL('PmenuSbar', s:none, s:bg2)
  call s:HL('PmenuSbar', s:none, ['#46484a',1])
  " Popup menu: scrollbar thumb
  " call s:HL('PmenuThumb', s:none, s:bg4)
  call s:HL('PmenuThumb', s:none, ['#46484a',1])
endif
...
" lines use sign.
hi! link GitGutterDelete IlyaRedSign
call s:HL('GitGutterAdd', s:green, s:green)
call s:HL('GitGutterChange',       s:gb.ilya_blue, s:gb.ilya_blue)
call s:HL('GitGutterChangeDelete', s:gb.ilya_blue, s:gb.ilya_blue)
...
" }}}
" Python: {{{
hi! link pythonRun IlyaTest
hi! link pythonCoding IlyaTest
hi! link pythonBuiltin IlyaTest

hi! link pythonBuiltinFunc IlyaPurple
" This looks like for dunder methods
hi! link pythonBuiltinObj IlyaBrightPink

hi! link pythonFunction IlyaBrightBlue

hi! link pythonInclude      IlyaOrange
hi! link pythonImport       IlyaOrange
hi! link pythonException    IlyaOrange
hi! link pythonExceptions   IlyaOrange
hi! link pythonBoolean      IlyaOrange
hi! link pythonConditional  IlyaOrange
hi! link pythonRepeat       IlyaOrange
" Affects 'in'
hi! link pythonOperator     IlyaOrange

" This affects decorator for whatever reason
hi! link pythonDottedName IlyaYellow
hi! link pythonDecorator IlyaYellow
