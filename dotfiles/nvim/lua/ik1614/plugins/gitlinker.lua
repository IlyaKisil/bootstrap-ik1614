return {
  {
    ...
    keys = {
      ...
      {"<leader>go", "<cmd>lua require('gitlinker').get_buf_range_url('v', {action_callback=require('gitlinker.actions').copy_to_clipboard})<cr>", mode="v", desc="[G]it range: Copy link to a clipboard"},
